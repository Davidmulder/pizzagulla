...
$query_usuario = "SELECT * FROM letter ORDER BY id DESC";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Newletter</h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_newletter.php?area=1">Mandar Mensagem  </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			...
			<tbody>
		      ...
		      <tr>
			      ...
			      <td><a href="deletar.php?del=9&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		      </tr>
