...
<div id="tabledata" class="section">
		...
		<table width="832" id="table">
			...
			<tr>
				<th width="35">&nbsp;</th>
				<th width="117">Data</th>
				<th width="130">ID</th>
				<th width="297">Enquete</th>
				<th width="86">Sorteio</th>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['data']; 
				  ...
				  <a href="#" onclick="window.open('sorteio_ativo.php?id=<?php echo $row_usuario['id']; ?>', '', 'toolbar=0,location=0,status=0,menubar=0,scrollbars=yes,resizable=0,width=658,height=500')">
				  
				  Ativa&ccedil;&atilde;o</a></td>
			      <td>
				 ...
				 echo "Inativo";
				  ...
				  <span style="font-weight: bold"><a href="opcao.php?area=<?php echo $row_usuario['id']; ?>&quest=<?php echo $row_usuario['titulo']; ?>">Opções</a></span> &nbsp;&nbsp;
