...
$query_usuario = "SELECT * FROM areas ORDER BY id ASC";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Areas do Site </h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_areas.php">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			...
			<tbody>
              ...
              <tr>
                  ...
                  <td><a href="deletar.php?del=10&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_areas.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
              </tr>
