...
$query_usuario = "SELECT * FROM destaque ORDER BY tipo ASC ";
...
<div id="tabledata" class="section">
			...
			<table width="299" height="19" border="0" cellpadding="0" cellspacing="1">
              <tr>
                <td width="133" class="ico_success"> <a href="add_destaque.php">Novo Registro </a></td>
                <td width="163" align="right" ><a href="ok2.php">Atualizar Home</a> </td>
              </tr>
        </table>
		<table id="table">
			<thead>
			<tr>
				<th width="33">&nbsp;</th>
				<th width="116">ID</th>
				<th width="240">Area</th>
				<th width="385">Titulo</th>
			...
			<tbody>
		      ...
		      <tr>
				  ...
				  switch($tipo){
				  case 1:
				  echo "Imagem Grande (650 x 217px)";
				 break;
				  case 2:
				  echo "Texto Central (Sem foto)";
				  break;
				  case 3:
				  echo "Foto Lateral (148 x 298px)";
				  break;
				  case 4:
				  echo "Chamada enquete";
				  break;
			      ...
			      <td><a href="deletar.php?del=4&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_destaque.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
