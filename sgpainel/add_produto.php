...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO produto (titulo, texto, id_cat, valor, `data`) VALUES (%s, %s, %s, %s, %s)",
...
do {  
?>
                        <option value="<?php echo $row_categoria['id']?>"><?php echo $row_categoria['tipo']?></option>
                        <?php
