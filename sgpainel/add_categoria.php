...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO categoria (tipo, texto, foto) VALUES (%s, %s, %s)",
		...
		<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form" accept-charset="iso-8859-1">
			...
			<?php }?>
				  <table width="400" border="0" cellpadding="2" cellspacing="3" class="texto_formulario">
                    ...
                    <tr>
                      <td><input name="tipo" type="text" class="form2" id="tipo" size="50" /></td>
                    </tr>
                    <tr>
                      <td>Foto</td>
                    </tr>
                    <tr>
                      <td><input name="foto" type="text" class="form2" id="foto" size="50" /></td>
                    </tr>
                    <tr>
                      <td>Texto</td>
                    </tr>
                    <tr>
                      <td><textarea name="texto" cols="50" class="form2" id="texto"></textarea></td>
                    </tr>
                    <tr>
