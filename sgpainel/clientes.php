...
$query_usuario = "SELECT id,nome,data,acesso,email,uf FROM cliente ORDER BY id desc ";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Clientes</h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"><a href="add_cliente.php">Novo Registro </a></td>
              </tr>
            </table>
			<table id="table">
			<thead>
			<tr>
				<th width="72">ID</th>
				<th width="211">Nome</th>
				<th width="186">Email</th>
				<th width="187">UF</th>
			...
			<tbody>
			  <?php do { ?>
		      <tr>
			      <td class="table_check"><?php echo $row_usuario['id']; ?></td>
			      <td class="table_title" style="font-weight: bold"><?php echo $row_usuario['nome']; ?></td>
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['email']; ?> </span></td>
			      <td class="table_title" style="font-weight: bold"><?php echo $row_usuario['uf']; ?></td>
			      <td><a href="deletar.php?del=5&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_cliente.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
