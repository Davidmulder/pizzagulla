...
$query_usuario = "select ar.id,ar.nome,ar.data,cli.nome as cliente,are.titulo as tipo from arquivo ar inner join cliente cli on (cli.id = ar.id_cliente) inner join areas are on (are.id = ar.id_area) where are.id = '$area' order by ar.id desc";
...
<div id="tabledata" class="section">
			<h2 class="ico_mug">Midia <?php echo $row_usuario['tipo']; ?></h2>
			
			<table width="200" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td class="ico_success"> <a href="add_arquivo.php?area=<?php echo $area; ?>">Novo Registro </a></td>
              </tr>
            </table>
		<table id="table">
			<thead>
			<tr>
				...
				<th width="215">Nome</th>
				<th width="196">Cliente</th>
				<th width="196">Tipo</th>
			...
			<tbody>
		      ...
		      <tr>
				 ...
				 $vdata= $row_usuario['data']; 
			      ...
			      <td class="table_title" style="font-weight: bold"><span class="table_title" style="font-weight: bold"><?php echo $row_usuario['cliente']; ?> </span></td>
			      <td class="table_title" style="font-weight: bold"><?php echo $row_usuario['tipo']; ?></td>
			      <td><a href="deletar.php?del=7&id=<?php echo $row_usuario['id']; ?>"><img src="img/cancel.jpg" alt="cancel" border="0"/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="edit_arquivo.php?id=<?php echo $row_usuario['id']; ?>"><img src="img/edit.jpg" alt="edit" border="0"/></a></td>
		      </tr>
